...
export const ROADMAP_EPICS: RoadmapEpic[] = [
  ...
  },
  {
    ...
    status: "IN PROGRESS",
    stories: [
      { id: "s2-1", title: "Live SSE assessment streaming", status: "done", priority: "P0", owner: "CORTEX", phase: 2 },
      ...
      { id: "s2-5", title: "Wire real assessment scores to posture", status: "in_progress", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s2-6", title: "Trend data from historical runs", status: "in_progress", priority: "P1", owner: "CORTEX", phase: 2 },
      { id: "s2-7", title: "Human Review Workflow UI", status: "not_started", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s2-8", title: "Remediation Tracker", status: "not_started", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s2-9", title: "Audit Report Generator PDF", status: "not_started", priority: "P1", owner: "Cursor", phase: 2 },
  ...
  },
  {
    ...
    status: "IN PROGRESS",
    stories: [
      { id: "s3-1", title: "Org structure seeding — 6 entities", status: "done", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s3-2", title: "ISO 27001 mock policy documents", status: "done", priority: "P1", owner: "Cursor", phase: 2 },
      { id: "s3-3", title: "Document ingestion pipeline", status: "in_progress", priority: "P1", owner: "CORTEX", phase: 2 },
      { id: "s3-4", title: "Azure connector", status: "in_progress", priority: "P1", owner: "CORTEX", phase: 2 },
      ...
      { id: "s3-7", title: "Real-time environment scanning", status: "not_started", priority: "P2", owner: "Manual", phase: 3 },
      { id: "s3-8", title: "Test document ingestion end to end", status: "not_started", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s3-9", title: "Test Azure connector end to end", status: "not_started", priority: "P0", owner: "CORTEX", phase: 2 },
      { id: "s3-10", title: "Test AWS connector end to end", status: "not_started", priority: "P0", owner: "CORTEX", phase: 2 },
    ],
  },
  {
    id: "epic-4",
